...
const movementCategory = locale => category(getEstText('category.movement', locale), 'movement', 'movement', [
    ...
    separator,
    block('drive_line_follow_init'),
    block('drive_line_follow_dual_step', `${numberShadow('LEFT_INPUT', 50)}${numberShadow('RIGHT_INPUT', 50)}${numberShadow('LEFT_BASE_POWER', 30)}${numberShadow('RIGHT_BASE_POWER', 30)}${numberShadow('KP', 1)}${numberShadow('KD', 0.01)}`)
]);
...
const sensorCategory = locale => category(getEstText('category.sensing', locale), 'sensors', 'sensing', [
    ...
    block('sensor_color_ambient_compare', `${sensorPortShadow('PORT', '1')}${field('COMPARATOR', 'less')}${numberShadow('VALUE', 50)}`),
    block('sensor_color_value', sensorPortShadow('PORT', '1')),
    block('sensor_color_is', `${sensorPortShadow('PORT', '1')}${field('COLOR', 'red')}`),
    block('sensor_wait_color', `${sensorPortShadow('PORT', '1')}${field('COLOR_EVENT', 'red')}`),
    separator,
    block('sensor_temperature', `${sensorPortShadow('PORT', '1')}${field('UNIT', 'celsius')}`),
    separator,
    ...
    separator,
    block('sensor_ultrasonic_distance', `${sensorPortShadow('PORT', '1')}${field('UNIT', 'centimeters')}`),
    block('sensor_ultrasonic_compare', `${sensorPortShadow('PORT', '1')}${field('COMPARATOR', 'less')}${numberShadow('VALUE', 15)}${field('UNIT', 'centimeters')}`),
    block('sensor_wait_ultrasonic', `${sensorPortShadow('PORT', '1')}${field('COMPARATOR', 'less')}${numberShadow('VALUE', 15)}${field('UNIT', 'centimeters')}`),
    separator,
    ...
    block('sensor_gyro_reset', sensorPortShadow('PORT', '1')),
    block('sensor_gyro_compare', `${sensorPortShadow('PORT', '1')}${field('COMPARATOR', 'less')}${numberShadow('VALUE', 45)}`),
    block('sensor_wait_gyro', `${sensorPortShadow('PORT', '1')}${field('COMPARATOR', 'less')}${numberShadow('VALUE', 45)}`),
    separator,
    block('sensor_timer'),
